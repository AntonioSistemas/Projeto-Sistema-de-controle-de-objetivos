...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Back.setGeometry(QtCore.QRect(-20, -30, 811, 531))
        ...
        self.B_MeusObjetivos.setGeometry(QtCore.QRect(0, 120, 201, 31))
        font = QtGui.QFont()
        ...
        self.B_NovoObjetivo.setGeometry(QtCore.QRect(0, 160, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.NomeUsuario_Meio.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Nome_Usuario</span></p></body></html>"))
